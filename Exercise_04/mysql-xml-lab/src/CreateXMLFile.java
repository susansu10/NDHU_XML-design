		 	      ...
		 	      ) 
		 	  {
		    	  while(rs.next())
		    	  {
		    		  try
		    		  {
		    			  ...
		    			  firstn = rs.getString("first");
		    			  System.out.println(", Last: " + rs.getString("last"));
		    			  lastn = rs.getString("last");
		    			  System.out.println(", Last: " + rs.getString("nick"));
		    			  nickn = rs.getString("nick");
		    			  ...
		    			  firstname.appendChild(doc.createTextNode(firstn));
		    			  student.appendChild(firstname);
		          
		    			  // lastname element
		    			  Element lastname = doc.createElement("lastname");
		    			  lastname.appendChild(doc.createTextNode(lastn));
		    			  student.appendChild(lastname);
		          
		    			  // nickname element
		    			  Element nickname = doc.createElement("nickname");
		    			  nickname.appendChild(doc.createTextNode(nickn));
		    			  student.appendChild(nickname);
		          
		    			  // marks element
		    			  Element marks = doc.createElement("marks");
		    			  marks.appendChild(doc.createTextNode(Integer.toString(mark)));
